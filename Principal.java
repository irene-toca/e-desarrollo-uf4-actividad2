...
public class Principal {
	...
	public static void main(String[] args) {
		...
		case "divison":
			...
			System.out.println("Pulse 3 para la raiz de un numero");
			System.out.println("Pulse 4 para inverso de un número real");
			
			// Entrada por teclado
			int operacionProducto = entrada.nextInt();
			
			// Switch de la seleccion de una operacion del menu
	...
	public static void main(String[] args) {
		...
		case "divison" :
			...
			System.out.println("Pulse 1 para division de dos números reales");
			System.out.println("Pulse 2 para division de dos números enteros");
			System.out.println("Pulse 3 para inverso de un número real");
			System.out.println("Pulse 4 para raiz de un número");
			...
			case 3:
				System.out.println("Introduzca primer digito");
				num1Real = entrada.nextDouble();
				System.out.println("El resultado es: " + Division.raiz(num1Entero));
				break;
			...
			case 4:
				System.out.println("Introduzca primer digito");
				num1Real = entrada.nextDouble();
				System.out.println("El resultado es: " + Division.inversoreal(num1Entero));
				break;
